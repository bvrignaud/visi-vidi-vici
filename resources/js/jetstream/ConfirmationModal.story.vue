...
<template>
  <Story title="Jetstream/ConfirmationModal">
    <Variant title="Default">
      <div class="p-6">
        <ConfirmationModal :show="state.show" :max-width="state.maxWidth" :closeable="state.closeable"
                           @close="closeModal">
          <template #title>
            Are you sure?
          </template>
    ...
    <Variant title="Not Closeable">
      <div class="p-6">
        <ConfirmationModal :show="state.show" :max-width="state.maxWidth" :closeable="false" @close="closeModal">
          <template #title>
            Not Closeable Modal
          </template>
          <template #content>
    ...
    <Variant title="Small Width">
      <div class="p-6">
        <ConfirmationModal :show="state.show" max-width="sm" :closeable="state.closeable" @close="closeModal">
          <template #title>
            Small Modal
          </template>
          <template #content>
            This is a small modal with a width of 'sm'.
          </template>
          <template #footer>
            <SecondaryButton @click="closeModal">Cancel</SecondaryButton>
            <Button class="ml-2">Confirm</Button>
